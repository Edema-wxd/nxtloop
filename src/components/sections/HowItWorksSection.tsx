            ...
            >
              <Card className="text-center hover:scale-105 transition-transform bg-white border border-gray-100 shadow-sm hover:shadow-md">
                <CardContent className="p-6">
                  <div
                    className={`w-12 h-12 ${step.color} rounded-full flex items-center justify-center mx-auto mb-4 border border-gray-200`}
                  >
                  ...
                  <p className="text-[#2a2d34]/80">{step.desc}</p>
                </CardContent>
              </Card>
            </motion.div>
          ))}
